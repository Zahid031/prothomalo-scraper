...
def scrape_category_task(self, task_id, category, max_pages=2):
    """Celery task to scrape articles from a category"""
...
class CategoryScraper:
    """Scraper for different categories"""
    ...
    def parse_bengali_date(self, date_str):
        """Parse Bengali datetime to ISO format"""
    ...
    def bulk_index_articles(self, articles):
        ...
        try:
            ...
            es_client.create_index_if_not_exists(self.category)
            
            actions = []
            index_name = es_client.get_index_name(self.category)
